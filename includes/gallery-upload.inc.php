...
if (isset($_POST['submit'])){
    ...
    if (empty($newFileName)){
        ...
        $newFileName = strtolower(str_ireplace("","-", $newFileName));
    }
            ...
            if ($fileSize < 2000000){
                ...
                if (empty($imageTitle) || empty($imageDesc)){
                    ...
                    if (!mysqli_stmt_prepare($stmt, $sql)){
                        ...
                        $sql = "INSERT INTO gallery(titleGallery, descGallery, imgFullNameGallary, orderGallary) VALUES (?, ?, ?, ?, ?)";
                        if (!mysqli_stmt_prepare($stmt, $sql)){
                            echo "SQL statement failed!";
                        } else {
